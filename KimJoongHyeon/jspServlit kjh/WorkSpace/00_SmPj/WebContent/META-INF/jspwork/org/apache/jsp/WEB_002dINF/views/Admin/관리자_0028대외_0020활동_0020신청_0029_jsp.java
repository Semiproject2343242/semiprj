 ...
 * Generated at: 2020-09-08 08:18:56 UTC
...
public final class 관리자_0028대외_0020활동_0020신청_0029_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser.getMemberName().equals("관리자")) { 
      ...
      out.write("                        <option>승인 대기</option>\r\n");
      out.write("                        <option>승인 완료</option>\r\n");
      out.write("                    </select>\r\n");
 ...
 if(list.isEmpty()){ 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"hidden\" id=\"id\" value=\"");
...
if(!list.isEmpty()){
      ...
      out.write("\t                var enroll = $(this).parent().children().children('#id').val();\r\n");
      out.write("\t        \t\tconsole.log(\"enroll : \" + enroll);\r\n");
      out.write("\t            ");
 if(loginUser != null){
      out.write('\r');
      out.write('\n');
