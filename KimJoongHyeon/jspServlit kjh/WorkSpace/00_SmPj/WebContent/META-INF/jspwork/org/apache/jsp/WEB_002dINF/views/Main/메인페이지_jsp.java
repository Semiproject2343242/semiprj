 ...
 * Generated at: 2020-08-31 10:31:33 UTC
...
public final class 메인페이지_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/Main/../Common/header.jsp", Long.valueOf(1598772679072L));
    _jspx_dependants.put("/WEB-INF/views/Main/../Common/footer.jsp", Long.valueOf(1598268603797L));
  }
 ...
 for (Board b : noticeList) { 
      ...
      out.write("\t\t\t<script>\r\n");
      out.write("        $(function(){\r\n");
      out.write("\t            $('#notice_title .area_list_title').mouseenter(function(){\r\n");
...
if (loginUser != null) {
 ...
 for (Board b : commuList) { 
      ...
      out.write("\t\t\t<div class=\"list_type_b\">\r\n");
      out.write("\t\t\t\t<div class=\"area_title\">\r\n");
      out.write("\t\t\t\t\t<a href=\"#\"><h3>QA_TEST용</h3></a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<ul id=\"qa_title\">\r\n");
      out.write("\t\t\t\t\t");
 if (qaList.isEmpty()) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"#\" class=\"area_list_qa\">조회된 리스트가 없습니다.</a></li>\r\n");
      out.write("\t\t\t\t\t");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t");
