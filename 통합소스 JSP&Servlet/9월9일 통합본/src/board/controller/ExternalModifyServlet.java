 ...
 */
@WebServlet("/modify.ea")
public class ExternalModifyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExternalModifyServlet() {
        super();
...
//	         System.out.println(b);
	         ...
	         if(mainfile==null || mainfile.length() == 0) {
        		 ...
        		 result = new ExternalService().AddFile(b, fileList);
	         }
	         
	         result = new ExternalService().modifyBoard(b, fileList);
	         
	         if(result>0) {
	            response.sendRedirect("main.ea");
	         }else {
