 ...
 * Generated at: 2020-09-10 00:54:11 UTC
...
public final class 아이디찾기_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("   \t }\r\n");
      out.write("   \t  #idSearchButton{background-color:darkgray; border-radius: 3px; border:none;}\r\n");
      out.write("}\r\n");
      out.write("    .checknumber{width:100px;}\r\n");
      out.write("    #idsearchbutton{background-color:darkgray; border-radius: 3px; border:none;}\r\n");
      out.write("</style>\r\n");
      out.write("<body>\r\n");
      out.write("    ");
 ...
 if(loginUser.getMemberName().equals("관리자")) { 
      ...
      out.write("            <section id=id_serch_Section >\r\n");
      out.write("               ");
      out.write("\r\n");
      ...
      out.write("\t                            <tr>\r\n");
      out.write("\t                                <td style = text-align:right>이름 :</td>\r\n");
      out.write("\t                                <td>\r\n");
      out.write("\t                                \t<input type=\"text\" name =\"userName\" id=\"userName\" placeholder=\"이름을 입력해주세요\">\r\n");
      out.write("\t                                </td>\r\n");
      out.write("\t                            <tr>\r\n");
      out.write("\t                                <td style = text-align:right><input type=radio name=idsearchradio value=\"phone\" checked>휴대폰번호 :</td>\r\n");
      out.write("\t                                <td>\r\n");
      out.write("\t                                \t<input type=\"phone\" name=\"userPhone\" id=\"userPhone\" placeholder=\"'-' 없이 입력해주세요\">\r\n");
      out.write("\t                                </td>\r\n");
      out.write("\t                            </tr>   \r\n");
      out.write("\t                            </tr>\r\n");
      out.write("\t                            <tr>\r\n");
      out.write("\t                                <td style = text-align:right><input type=radio name=idsearchradio value=\"email\">이메일 :</td>\r\n");
      out.write("\t                                <td>\r\n");
      out.write("\t                                \t<input type=\"email\" name=\"userEmail\" id=\"userEmail\" placeholder=\"이메일을 입력해주세요\">\r\n");
      out.write("\t                                </td>\r\n");
      out.write("\t                            </tr>\r\n");
      out.write("\t                        </table>\r\n");
      out.write("                        <p align=\"center\">\r\n");
      out.write("                        \t<input type=\"button\" align=\"center\" name=\"idSearchButton\" id=\"idSearchButton\" style=\"width: 60pt; height: 30pt\" value=\"확인\">\r\n");
      out.write("                        \t<input type=\"button\" style=\"width: 60pt; height: 30pt\" onclick=\"location.href='javascript:history.go(-1);'\" value=\"취소\">\r\n");
      out.write("                        </p>\r\n");
      out.write("                   </div>\r\n");
      out.write("                        <p style=\"height:100px; width:100%; text-align:center; font-size: 150%;\" id=\"idResult2\"></p>\r\n");
      out.write("                        <script>\r\n");
      out.write("\t\t\t\t\t\t\t$('#idSearchButton').click(function(){\r\n");
      out.write("\t\t\t\t\t\t\t\tvar name = $('#userName');\r\n");
      out.write("\t\t\t\t\t\t\t\tvar phone = $('#userPhone');\r\n");
      out.write("\t\t\t\t\t\t\t\tvar email = $('#userEmail');\r\n");
      out.write("\t\t\t\t\t\t        var radio = $('input[name=\"idsearchradio\"]:checked');\r\n");
      out.write("\t\t\t\t\t\t        \r\n");
      out.write("\t\t\t\t\t\t       \tconsole.log(radio);\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\turl: \"");
      out.print( request.getContextPath() );
      out.write("/searchId.me\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype: 'post',\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdata: { name:name.val(), phone:phone.val() , email:email.val() , radio: radio.val() },\r\n");
      out.write("\t\t\t\t\t\t\t\t\tsuccess: function(data){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tconsole.log(data);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$('#idResult2').text('');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\t\t\t\t\t\tif(data.length > 2 ){\r\n");
      out.write(" \t\t\t\t\t\t\t\t\t\t\t$('#idResult2').append('아이디는');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$('#idResult2').append(data);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$('#idResult2').append(' 입니다.');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$('#idResult2').css({'color':'black'});\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t} else{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$('#idResult2').text('찾을 수 없습니다.');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$('#idResult2').css({'color':'red'});\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("/* \t\t\t\t\t\t\t\t\t\tfor(var i =0; i<data.length; i++){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$('#idResult2').append(data[i]);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tif(data[i]=='.'){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t$('#idResult2').append('<br>');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t} */\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t});\r\n");
