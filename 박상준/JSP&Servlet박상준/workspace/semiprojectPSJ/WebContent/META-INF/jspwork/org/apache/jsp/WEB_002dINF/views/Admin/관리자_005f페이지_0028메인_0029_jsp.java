 ...
 * Generated at: 2020-09-11 03:14:29 UTC
...
public final class 관리자_005f페이지_0028메인_0029_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(profile == null) { 
      ...
      out.write("\t\t\t\t<h1 align='left'>최근 게시글</h1>\r\n");
      out.write("\t\t\t\t<hr>\r\n");
 ...
 for (Board b : commuFreeList) { 
      ...
      out.write("\t\t\t\t\t               $(this).css('none');\r\n");
      out.write("\t\t\t\t\t           \t}).click(function(){\r\n");
      out.write("\t\t\t\t\t           \t \tvar bId = $(this).parent().children('.area_list_no').val();\r\n");
      out.write("\t\t\t\t\t\t       \t \tvar bName = $(this).parent().children('.area_list_title').val();\r\n");
