 ...
 * Generated at: 2020-09-11 02:55:50 UTC
...
public final class 로그인_005f페이지_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser.getMemberName().equals("관리자")) { 
      ...
      out.write("               <a href=\"");
      out.print(request.getContextPath());
      out.write("/searchIdForm.me\">아이디 찾기</a> | <a href=\"");
      out.print(request.getContextPath());
      out.write("/searchPwdForm.me\">비밀번호 찾기</a> | <a href=\"");
      out.print(request.getContextPath());
      out.write("/insertForm.me\">회원가입</a>\r\n");
      out.write("            </p>\r\n");
      out.write("            <a id=\"login-form-btn\" href=\"javascript:loginFormWithKakao()\">\r\n");
      out.write("  <img\r\n");
      out.write("    src=\"//k.kakaocdn.net/14/dn/btqCn0WEmI3/nijroPfbpCa4at5EIsjyf0/o.jpg\"\r\n");
      out.write("    width=\"222\"\r\n");
      out.write("  />\r\n");
      out.write("</a>\r\n");
      out.write("         </div>\r\n");
      ...
      out.write("      </div>\r\n");
      out.write("\r\n");
      out.write("<p id=\"login-form-result\"></p>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\t// SDK를 초기화 합니다. 사용할 앱의 JavaScript 키를 설정해 주세요.\r\n");
      out.write("\tKakao.init('d1a381394433d1a528af9cc55303a286');\r\n");
      out.write("\t\r\n");
      out.write("\t// SDK 초기화 여부를 판단합니다.\r\n");
      out.write("\tconsole.log(Kakao.isInitialized());\r\n");
      out.write("  function loginFormWithKakao() {\r\n");
      out.write("    Kakao.Auth.loginForm({\r\n");
      out.write("      success: function(authObj) {\r\n");
      out.write("//         showResult(JSON.stringify(authObj))\r\n");
      out.write("        Kakao.API.request({\r\n");
      out.write("            url: '/v2/user/me',\r\n");
      out.write("            success: function(response) {\r\n");
      out.write("                console.log(response);\r\n");
      out.write("//                 console.log(response.kakao_account.email);\r\n");
      out.write("//                 console.log(response.properties.nickname);\r\n");
      out.write("                kakaoLogin(response.kakao_account.email,response.properties.nickname);\r\n");
      out.write("            },\r\n");
      ...
      out.write("        showResult(JSON.stringify(err))\r\n");
      out.write("      },\r\n");
      out.write("    })\r\n");
      out.write("  }\r\n");
      out.write("  function showResult(result) {\r\n");
      out.write("    document.getElementById('login-form-result').innerText = result\r\n");
      out.write("  }\r\n");
      out.write("  \r\n");
      out.write("  function kakaoLogin(email,name){\r\n");
      out.write("\t  location.href = '");
      out.print(request.getContextPath());
      out.write("/kakaoLogin.me?email='+ email +'&name=' + name;\r\n");
      out.write("  }\r\n");
      out.write("</script>\r\n");
      out.write("   </section>\r\n");
      out.write("\r\n");
