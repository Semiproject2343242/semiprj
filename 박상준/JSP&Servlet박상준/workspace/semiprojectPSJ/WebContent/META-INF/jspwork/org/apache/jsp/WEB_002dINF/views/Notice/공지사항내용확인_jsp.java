 ...
 * Generated at: 2020-09-11 06:07:49 UTC
...
public final class 공지사항내용확인_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/Notice/../Common/footer.jsp", Long.valueOf(1599750369908L));
  }
 ...
 if(loginUser.getMemberName().equals("관리자")) { 
      ...
      out.write("\t\t\t<form action=\"modifyForm.no\" id=\"detailForm\" name=\"detailForm\" method=\"post\">\t        \r\n");
      out.write("\t        \r\n");
...
for(int i=0; i < fileList.size(); i++){ 
 ...
 if(b.getBoardWriter().equals(loginUser.getMemberNickName()) || loginUser.getMemberNickName().equals("운영자")) { 
      ...
      out.print( request.getContextPath() );
      out.write("/main.no'\" id=\"menuBtn\" value=\"메뉴로\">\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<script>\r\n");
...
if(loginUser != null){ 
 ...
 if(replyList.get(i).getReplyWriter().equals(loginUser.getMemberNickName()) || loginUser.getMemberNickName().equals("운영자")) { 
      ...
      out.write("\t\t\t\t\t\t\t    \tlocation.href=\"");
      out.print( request.getContextPath() );
      out.write("/replyDelete.re?replyNo=\"+replyNo+\"&boardNo=\"+boardNo+\"&bName=공지사항\";\r\n");
      out.write("\t\t\t\t\t\t\t    } else{\r\n");
      out.write("\t\t\t\t\t\t\t        alert('취소하셨습니다.');\r\n");
      out.write("\t\t\t\t\t\t\t    }\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
 ...
 if(loginUser != null){ 
      ...
      out.print( b.getBoardNo() );
      out.write("\">\r\n");
      out.write("\t\t\t            <input type=\"hidden\" name=\"bName\" value=\"공지사항\">\t\r\n");
