 ...
 <div class="select_box">
          <h3>
              <select class="categoty_select" id="sp_category">
                  ...
                  <option value="기업지원" <%= categoryarr[3] %> >기업지원</option>
                  <option value="창업지원" <%= categoryarr[4] %> >창업지원</option>
                  <option value="생활/금융" <%= categoryarr[5] %> >생활/금융</option>
                  <option value="교통/주거" <%= categoryarr[6] %> >교통/주거</option>
              </select>
          </h3>
          <h3>
          	<div>
           	...
           	<div id="ck_sp_emState">
				<input type="checkbox" name="ck_sp_em" id="ck_sp_em" value="재직중" <%= emStatearr[0] %>>
				<input type="checkbox" name="ck_sp_em" id="ck_sp_nem" value="구직중" <%= emStatearr[1] %>>
            </div>
          </h3>
          <script>
          	$(function(){
          ...
          <h3>
              ...
              <div id="ck_sp_age">
				<input type="checkbox" name="ck_sp_age" id="ck_sp_age_18" value="청년" <%= tcarr[0] %>>
				<input type="checkbox" name="ck_sp_age" id="ck_sp_age_35" value="중년" <%= tcarr[1] %>>
				<input type="checkbox" name="ck_sp_age" id="ck_sp_age_50" value="장년" <%= tcarr[2] %>>
				<input type="checkbox" name="ck_sp_age" id="ck_sp_age_65" value="어르신" <%= tcarr[3] %>>
            </div>
            <script>
            $(document).ready(function(){
            	if($("#ck_sp_em").is(":checked") == true){
              		 $("#sp_em").css({'background':'darkgray'});
              		}
              		if($("#ck_sp_nem").is(":checked") == true){
              		  	 $("#sp_nem").css({'background':'darkgray'});
              	    }
            	if($("#ck_sp_age_18").is(":checked") == true){
           		 $("#sp_age_18").css({'background':'darkgray'});
           		}
           		if($("#ck_sp_age_35").is(":checked") == true){
           		  	 $("#sp_age_35").css({'background':'darkgray'});
           	    }
           		if($("#ck_sp_age_50").is(":checked") == true){
           		  	 $("#sp_age_50").css({'background':'darkgray'});
           	    }
           		if($("#ck_sp_age_65").is(":checked") == true){
           		  	 $("#sp_age_65").css({'background':'darkgray'});
           	    }
    ...
    <input type="hidden" size="50" name="no" value="<%= b.getBoardNo() %>">
     <table class="writer_table">
          <tr>
            <th width="15%">제목</th>
            <td width="50%" colspan="3"><input type ="text" name = "sp_title" placeholder="제목을 입력하세요." class=textline1 value="<%=b.getBoardTitle() %>"></td>
          </tr>
          <tr>
            <th>현재 메인 이미지</th>
            <td colspan="3" name="sp_orgin_title_image" value="<%=titleImg.getOriginName() %>"><%= titleImg.getOriginName() %></td>
          </tr>
          <tr>
            <th>메인 이미지 수정</th>
            <td colspan="3"><input type ="file" multiple="multiple" id="sp_title_image" name = "sp_title_image" class=textline2></td>
          </tr>
          <tr>
            <th>모집 일정</th>
          ...
          <tr>
            <th>내용</th>
            <td><textarea class="form-control" name="sp_text_contents" id="sp_text_Contents" placeholder="내용을 입력해 주세요" ><%=b.getBoardContent() %></textarea></td>
          </tr>
           <%if(fList.size()>1){ %>
	          	<tr>
	            <th>현재 참고자료</th>
	            ...
	            <tr>
	            <th>참고자료 수정</th>
	            <td colspan="3"><input type ="file"  multiple="multiple" id="sp_main_image" name = "sp_main_image" class=textline2></td>
	            </tr>
            <%}else{ %>
	            <tr>
	            <th>참고자료</th>
	            <td colspan="3"><input type ="file"  multiple="multiple" id="sp_main_image" name = "titleImage" class=textline2></td>
	            </tr>
            <%} %>
        </table>
    </div>
