...
/**
 * Servlet implementation class CommuSupportModifyServlet
 */
@WebServlet("/spModify.cm")
public class CommuSupportModifyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommuSupportModifyServlet() {
        super();
