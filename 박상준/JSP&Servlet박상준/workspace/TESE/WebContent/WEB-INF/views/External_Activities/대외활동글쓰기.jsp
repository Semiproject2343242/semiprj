...
<body>
 ...
 <section>
 <div id="main_section">
  <form action="<%= request.getContextPath() %>/insert.ea" method="post" encType="multipart/form-data">
    ...
    <div class = "ea_button">
      ...
      <input type="button" id="cancelBtn" onclick="location.href='<%= request.getContextPath() %>/main.ea'" value="취소하기">
    </div>
  </form>
  </div>
</section>  
